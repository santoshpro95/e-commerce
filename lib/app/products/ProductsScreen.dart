...
class ProductScreen extends StatefulWidget {
  ...
  ProductScreen({Key key, this.productType,}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text(productType, style: TextStyle(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: Text("-"+snapshot.data[index].discount.toString()+"%", style: TextStyle(color: Colors.white,
                        ...
                        Container(
                          height: 20,
                          child: ListView.builder(itemBuilder: (context, index){
                            return index < rating ?Icon(Icons.star, size: 12, color: AppColors.orange,):
                            Icon(Icons.star_border,color: AppColors.lightGray, size: 12,);
                          },scrollDirection: Axis.horizontal, itemCount: 5,),
                        ),

                        Text(snapshot.data[index].name, style: TextStyle(
                            fontSize: 12, color: AppColors.lightGray, fontWeight: FontWeight.w400
                        ),),
                        SizedBox(height: 2,),
